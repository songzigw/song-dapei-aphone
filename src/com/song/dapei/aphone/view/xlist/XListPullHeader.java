package com.song.dapei.aphone.view.xlist;
...
public class XListPullHeader extends LinearLayout implements OnTouchListener {
	 ...
	 * @param attrs
	 */
	public XListPullHeader(Context context, AttributeSet attrs) {
		super(context, attrs);
		...
		header = LayoutInflater.from(context).inflate(
				R.layout.xlist_pull_header, null, true);
	...
	public void finishRefreshing() {
		...
		spu.setPullTime(UPDATED_AT + mId, System.currentTimeMillis());
		// preferences.edit()
	...
	private void refreshUpdatedAtValue() {
		lastUpdateTime = spu.getPullTime(UPDATED_AT + mId);
		...
		if (lastUpdateTime == -1) {
			updateAtValue = getResources().getString(
					R.string.xlistview_header_not_updated_yet);
		} else if (timePassed < 0) {
			updateAtValue = getResources().getString(
					R.string.xlistview_header_time_error);
		} else if (timePassed < ONE_MINUTE) {
			updateAtValue = getResources().getString(
					R.string.xlistview_header_updated_just_now);
		} else if (timePassed < ONE_HOUR) {
			timeIntoFormat = timePassed / ONE_MINUTE;
			String value = timeIntoFormat + "分钟";
			updateAtValue = String.format(
					getResources().getString(
							R.string.xlistview_header_updated_at), value);

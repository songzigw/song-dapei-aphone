 ...
 *
 */
public class CollocationUserAdapter extends BaseListAdapter<XCollocation> {

	public CollocationUserAdapter(Context context, List<XCollocation> list) {
		super(context, list);
	}
	...
	public View bindView(int position, View convertView, ViewGroup parent) {
		if (convertView == null) {
			convertView = mInflater.inflate(R.layout.item_collocation_user,
					null);
		}
